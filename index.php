                  ...
                  <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                          ...
                          <li class="nav-item">
                              ...
                              <li class="nav-item">
                                <a class="nav-link" href="#"><button class="btn btn-light  btn-sm" onclick="document.getElementById('login').style.display='block';document.getElementById('registration').style.display='none';document.getElementById('head1').style.display='none';document.getElementById('head2').style.display='none';  "> LOGIN </button></a>
                            
                          
                              </li>
                              </li>
                              <li class="nav-item">
                              <a class="nav-link" href="#"><button class="btn btn-light  btn-sm" onclick="document.getElementById('login').style.display='none';document.getElementById('registration').style.display='block';document.getElementById('head1').style.display='none';document.getElementById('head2').style.display='none'"> Register </button></a>
                              </li>
